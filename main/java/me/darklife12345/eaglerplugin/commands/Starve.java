        ...
        if (!(sender instanceof Player)) {
            switch (args.length) {
                case 0:
                    ...
                    sender.sendMessage(colorize("&4&lEagler &b&o: &e/starve &b<player>."));
                    break;
                case 1:
                    ...
                    if (target == null) {
                        ...
                        target.sendMessage(colorize("&4&lEagler &b&o: &aYou've been starved by the &e&oConsole&a."));
                        sender.sendMessage(colorize("&4&lEagler &b&o: &aYou've starved &e&o" + target.getName() + "&a."));
                    }
                    break;
            }
        } else {
